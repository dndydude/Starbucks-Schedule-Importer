...
/**
 * 
 * This code is from https://stackoverflow.com/questions/1132567/encrypt-password-in-configuration-files 
 * Some is edited but that is were the bulk is from.
 * 
 * 
 */
...
public class EncyptPlz {
	...
	public String encrypt(String property, SecretKeySpec key)
